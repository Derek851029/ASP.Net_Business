<%@ Page Language="C#" AutoEventWireup="true" CodeFile="0030010001Forget.aspx.cs" Inherits="_0030010001Forget" %>
    ...
    <form id="form1" runat="server">
        <div class="container" style="width: 100%">
            ...
            <div class="alert alert-info" style="width: 100%">
                <div><label style="font-size:72px;">密碼已更改完成</label> </div>
