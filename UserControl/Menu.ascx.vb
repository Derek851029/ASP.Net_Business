...
Partial Class UserControl_Menu
    ...
    Sub Menu_BindDB()
        Try
            ...
            menu = ""
            menu += "<li role='presentation'><a role='menuitem' id='menu_number'>&nbsp;帳戶編號：" & Session("SYSID") & "</a></li>"
            menu += "<li role='presentation'><a role='menuitem' id='menu_compony'>&nbsp;所屬公司：" & Session("Agent_Company") & "&nbsp;&nbsp;</a></li>"
            'menu += "<li role='presentation'><a role='menuitem' id='menu_department'>&nbsp;所屬部門：" & Session("Agent_Team") & "&nbsp;&nbsp;</a></li>"
            ...
            menu += "<li role='presentation'><a role='menuitem' id='menu_permission' >&nbsp;人員權限：" & txt & "&nbsp;&nbsp;</a></li>"
